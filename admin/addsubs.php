...
<div style="width:70%;height: 89vh;overflow-y: auto; background: white;margin-top: 3%;position: absolute;border-radius: 15px;">
  ...
  <center>
  <h2 style="margin: auto; justify-content: center;margin-top: 2vh;font-size: 2.2vw"><u>Manage Subscriptions</u></h2></center>
...
<?php
 ...
 {
  $id1=$_GET['id'];
  $sqls="SELECT * from subscribe where id='$id1'";
  ...
  if($rowss=mysqli_fetch_assoc($ress))
{
  ...
  $imgpath="../".$img."";
    ...
    <form method="POST" action="subsupdate.php" enctype="multipart/form-data">
    ...
    <tr>
            <td width="20%">
              Category<center><input type="text" class="form-control" name="category" readonly="" style="height:4.5vh " value="<?php echo $rowss['category']; ?>"/></center></td>
                <!--Category<center><select name="category" class="form-control"  style="height:5.1vh;font-size:.9vw;text-align: center;">
                  <option value="<?php echo $rowss['category']; ?>">Selected <?php echo $rowss['category']; ?></optgroup>
            ...
            <td width="20%">
              ...
              <td width="20%">
                price<center><input type="text" class="form-control" required="" name="price" style="height:4.5vh" value="<?php echo $rowss['bikeprice']; ?>"/></center></td>
        ...
        <td width="20%" style=""> 
             ...
             <td width="20%"> <img src="<?php echo $imgpath; ?>" width="100"></td><tr>
              <tr>
            <td colspan="4"><center><a href="addsubs.php" style="color:green">Back..</a>
  ...
  <input type="" name="" id="myInput" onkeyup="searchFun()" style="float: right;width: 13vw;margin-bottom: 2vh;border: 1px solid black" placeholder="search.." style="">
        <table class="table table-bordered" id="myTable" style="font-size: 1.1vw">
          ...
          <tr>
          	...
          	<td><center><span class="update"><a href="addsubs.php?id=<?php echo $rows['id']; ?>">View</a></span></center></td>

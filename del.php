...
$retsql="SELECT * from registration where username='$uname'";
$resul=mysqli_query($con,$retsql);
...
<br>
		...
		while($rows=mysqli_fetch_assoc($resul))
	{
		...
		<div class="del">
         	<div class="space">
                    <form action="delsuc.php" method="post"> 
                    	 ...
                    	 <h4 class="mb-3"><center><u>Delivery Address</u></center></h4><br>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" maxlength="30" name="fname" required id="firstName" placeholder="" onkeypress='return onlyAlphabets(event)' value=<?php echo $rows['name']; ?>>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" maxlength="30" required id="lastName" placeholder="" name="lname" onkeypress='return onlyAlphabets(event)' value=<?php echo $rows['lname']; ?>>
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" onkeypress='return valAdd(event)' name=address1 maxlength="100" name=address1 id="address" placeholder="1234 Main St" required value="<?php echo $rows['address']; ?>"/>
                                <div class="invalid-feedback">
            ...
            <input type="hidden" name="delusername" value=<?php echo $uname; ?>>
            ...
            <input type="hidden" name="model" value="<?php echo $model; ?>"/>
             ...
             <input type="hidden" name="enginecc" value=<?php echo $enginecc; ?>>
             <input type="hidden" name="power" value=<?php echo $power; ?>>
             <input type="hidden" name="abs" value=<?php echo $abs; ?>>
             <input type="hidden" name="mileage" value=<?php echo $mileage; ?>>
             <input type="hidden" name="fuelcap" value=<?php echo $fuelcap; ?>>

...
<?php
$query="SELECT * from accessories where category='Gear' and display='yes'";
...
<div class="container" style="margin-left: 205px; margin-top: -316px; position: relative;">
<?php
...
$_SESSION['success2'] = '<script>$.alert({

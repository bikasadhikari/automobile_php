...
<body onload="function1();onemon();oneplan();downpay();onemonemi();loadacces();">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" id="" href="#">Contact us<span class="sr-only">(current)</span></a>
      </li>
...
<body>
	...
	<div class="login">
		...
		<form action="login.php" method="post" style="">
			<p>Username</p>
			<input type="text" name="username" placeholder="Enter Username" onkeypress='return userName(event)'>
			<p>Password</p>
			<input type="Password" name="password" placeholder="Enter Password">
			<input type="submit" name="submit" value="Login"> 
			<br><a href="registrationdes.php"><u>Register now</u> </a>
     <?php

if(isset($_SESSION['blocked']) && ! empty($_SESSION['blocked']))
{
...
if(isset($_SESSION['rsuc']) && ! empty($_SESSION['rsuc']))
{
 echo $_SESSION['rsuc'];
 unset($_SESSION['rsuc']);
}

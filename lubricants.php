...
<?php
$query="SELECT * from accessories where category='Lubricants' and display='yes'";
...
<div class="container" style="margin-left: 200px; margin-top: -316px;">
	...
	<?php echo "<img src='".$rows['image']."' width='200' height='150' >"?><br>
			...
			<form action="lubricants.php" method="post">
			<script src="./src/bootstrap-input-spinner.js"></script>
<script>
    $("input[type='number']").inputSpinner()
</script>
  <b class="row5"> <u>  Qty</u><span style="padding: 5px;">:</span>  </b> <input type="number" maxlength="10" minlength="1" required="" name="qty" value="1" min="1" max="10" onkeypress="return onlyNumbers(event);"/>
</div>
...
<?php
session_start();
if(isset($_SESSION['success4']) && ! empty($_SESSION['success4']))
{
  echo $_SESSION['success4'];
...
{
	echo "'<script>
window.location.href='lubricants.php';
...
$_SESSION['success4'] = '<script>$.alert({

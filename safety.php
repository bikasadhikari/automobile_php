...
<?php
$query="SELECT * from accessories where category='Safety' and display='yes'";
...
<div class="container" style="margin-left: 205px; margin-top: -316px;">
<?php
...
<?php
session_start();
if(isset($_SESSION['success6']) && ! empty($_SESSION['success6']))
{
...
$_SESSION['success6'] = '<script>$.alert({

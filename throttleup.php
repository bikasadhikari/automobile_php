...
<head>
  ...
  <link rel="stylesheet" href="headers/facss/all.css">
  <link rel="stylesheet" href="headers/facss/v4-shims.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="throttleup.php"><img src="logo.png" class="logo" alt=""></a>
  <div class="uname">
  <?php
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <img src="slider12.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <div class="label">
        <h2>BUY</h2>
        <p>Own your Bike.</p></div>
      </div>
    </div>
    <div class="carousel-item">
      <img src="slider31.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <div class="label"><h2>SUBSCRIBE</h2>
        <p>Take home your dream bike without purchasing it.</p></div>
      </div>
    </div>
    <div class="carousel-item">
      <img src="slider2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
       <div class="label"> <h2>SERVICE AND ACCESSORIES</h2>
        <p></p></div>
      </div>
    </div>
  </div>
...
<h5 class="widget-title">THROTTLE UP<span></span></h5>
<p>Own or Subscribe your dream Bikes.We provide excellent services and Accessories that fits your bike.<br><strong>Service at your Doorstep.</strong></p>
</div>
</div>
...
<li>
<div class="thumb-content"><a href="throttleup.php">Home</a></div>  
</li>
<li>
<div class="thumb-content"><a href="indexsale.php">Buy</a></div>  
</li>
<li>
<div class="thumb-content"><a href="indexsubs.php">Subscribe</a></div>  
</li>
<li>
<div class="thumb-content"><a href="service.php">Service</a></div> 
</li>
<li>
<div class="thumb-content"><a href="acces.php">Accessories</a></div> 
</li>
<!--<li>
<div class="thumb-content"><a href="#.">Feedback</a></div>  
</li>
<li>
...
<button type="submit" name="register" class="btn">Register Now</button></form>
...
<p><a href="mailto:info@domain.com" title="glorythemes">info@throttleup.com</a></p>
...
<?php
session_start();
if(isset($_SESSION['booksuc']) && ! empty($_SESSION['booksuc']))
{
  echo $_SESSION['booksuc'];
 unset($_SESSION['booksuc']);
...
<?php
session_start();
if(isset($_SESSION['emibooksuc']) && ! empty($_SESSION['emibooksuc']))
{
  echo $_SESSION['emibooksuc'];
 unset($_SESSION['emibooksuc']);
...
<?php
session_start();
if(isset($_SESSION['purchasesuc']) && ! empty($_SESSION['purchasesuc']))
{
  echo $_SESSION['purchasesuc'];
 unset($_SESSION['purchasesuc']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['subsuc']) && ! empty($_SESSION['subsuc']))
{
  echo $_SESSION['subsuc'];
 unset($_SESSION['subsuc']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['servicesuc']) && ! empty($_SESSION['servicesuc']))
{
  echo $_SESSION['servicesuc'];
 unset($_SESSION['servicesuc']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['purchasefail']) && ! empty($_SESSION['purchasefail']))
{
  echo $_SESSION['purchasefail'];
 unset($_SESSION['purchasefail']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['subfail']) && ! empty($_SESSION['subfail']))
{
  echo $_SESSION['subfail'];
 unset($_SESSION['subfail']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['bookfail']) && ! empty($_SESSION['bookfail']))
{
  echo $_SESSION['bookfail'];
 unset($_SESSION['bookfail']);
 
}
?>
<?php
session_start();
if(isset($_SESSION['emibookfail']) && ! empty($_SESSION['emibookfail']))
{
  echo $_SESSION['emibookfail'];
 unset($_SESSION['emibookfail']);
